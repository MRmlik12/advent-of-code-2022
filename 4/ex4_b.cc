...
int main() {
    ...
    if (file.is_open()) {
        ...
        while (std::getline(file, line)) {
            ...
            if ((firstAssignmentNumberA <= secondAssignmentNumberA && secondAssignmentNumberA <= firstAssignmentNumberB)
                || (secondAssignmentNumberA <= firstAssignmentNumberA && firstAssignmentNumberA <= secondAssignmentNumberB)) {
                countPairs++;
            }
        }
    }
